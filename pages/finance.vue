              ...
              <nav aria-label="Main Nav" class="flex flex-col p-2">
                ...
                <ul class="space-y-1 border-t border-gray-100 pt-4">
                  ...
                  <li>
                    ...
                    >
                  <NuxtLink to="/finance/circuitFinance">  
                  ...
                  <li>
                    <a
                      ...
                      class="group relative flex justify-center rounded px-2 py-1.5 text-gray-500 hover:bg-gray-50 hover:text-gray-700"
                    >
                    <NuxtLink to="/finance/andrews/"> 
                      <svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M24 4V16" stroke="#333" stroke-width="1" stroke-linecap="round"/><path d="M20 8L28 8" stroke="#333" stroke-width="1" stroke-linecap="round"/><path d="M15 28H9C7.89543 28 7 28.8954 7 30V44" stroke="#333" stroke-width="1" stroke-linejoin="round"/><path d="M33 28H39C40.1046 28 41 28.8954 41 30V44" stroke="#333" stroke-width="1" stroke-linejoin="round"/><path d="M4 44L44 44" stroke="#333" stroke-width="1" stroke-linecap="round"/><path d="M15 23L24 15L33 23V44H15V23Z" fill="none" stroke="#333" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/><path d="M24 34V44" stroke="#333" stroke-width="1" stroke-linecap="round"/><path d="M20 44L28 44" stroke="#333" stroke-width="1" stroke-linecap="round"/></svg>
                    </NuxtLink>
                      <span
                        class="absolute left-full top-1/2 ml-4 -translate-y-1/2 rounded bg-gray-900 px-2 py-1.5 text-xs font-medium text-white opacity-0 group-hover:opacity-100"
                      >
