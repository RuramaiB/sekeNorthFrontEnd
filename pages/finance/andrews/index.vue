  ...
  <div class="mt-5 flex3 p-4 gap-3">
      <div class=" p-4 bg-white rounded shadow-sm">
              <div class="flex justify-between">
                  <b class=" m-2">St Andrews Finance Records</b>
                      <!-- Floating Download Button -->
                      <div class="fixed bottom-8 z-20 right-8">
                        <button class="bg-green-500 hover:bg-blue-600 rounded-full p-4 shadow-lg text-white flex items-center space-x-2">
...
export default {
  ...
  methods:{
   ...
   async handleOption (_option) {
    ...
    // async Delete(_option){
    //   if(_option = 'yes'){
    //     try{
    //     await axios.delete('http://localhost:8080/localFinance/deleteLocalFinanceByFinanceID/' + this.fetchLocalFinanceByIDFID,{
    //         headers: {'Content-Type': 'application/json'},
    //         credentials: 'include'
    //       }).then((response) =>{
    //       const data = response.data;
