  ...
  <div class="p-4 gap-3">
      <div class=" p-4 bg-white rounded shadow-md">
              <div class="flex justify-between">
                  <p class="m-2 text-lg font-semibold ">Ebenezer Organisations Finance Records</p>
                  <div>
                    <!-- Add Button -->
...
export default {
  ...
  async fetchAndOrgFinance(){
    this.loading = true;
    const URL = "http://localhost:8080/organisationsFinance/getAllOrganisationsByLocal?local=ebenezer";
